        ...
        <main>
            ...
            <div class="insights">
                <div class="active-cruise">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>Summer Cruises</h3>
                            <small>Starting at</small>
                            <h1><span style="font-weight: 800;">$39</span>/Day</h1>
                        </div>
                        <div class="progress">
                ...
                <div class="Seats">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>Spring Cruises</h3>
                            <small>Starting at</small>
                            <h1><span style="font-weight: 800;">$35</span>/Day</h1>
                        </div>
                        <div class="progress">
                            <button type="button" id="Change">Change</button>
                        </div>
            ...
            <div class="insights">
                <div class="active-cruise">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>Winter Cruises</h3>
                                <small>Starting at</small>
                                <h1><span style="font-weight: 800;">$50</span>/Day</h1>
                            </div>
                            <div class="progress">
                                <button type="button" id="Change">Change</button>
                            </div>
                ...
                <div class="Seats">
                    ...
                    <div class="middle">
                        <div class="left">
                            <h2>Autumn Cruises</h3>
                                <small>Starting at</small>
                                <h1><span style="font-weight: 800;">$29</span>/Day</h1>
                            </div>
                            <div class="progress">
                                <button type="button" id="Change">Change</button>
                            </div>
